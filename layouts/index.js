// copied from https://github.com/samselikoff/samselikoff.com/blob/master/layouts/index.js
...
const components = {
  h2: ({ children, ...rest }) => (
    <h2
      className='mt-12 text-xl font-semibold leading-tight text-gray-900 md:text-2xl'
      {...rest}
    >
      {children}
    </h2>
  ...
  h3: () => {
    throw new Error("Selikoff: Don't use an h3 in your blog posts, dude") // lol
  },
